                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            <c:if test="${currentPage != 1}">
                                <li class="page-item">
                                    <a class="page-link" href="/search-product?name=${key}&currentPage=${currentPage-1}" aria-label="Previous">
                            ...
                            <c:forEach begin="1" end="${totalPage}" var="i">
                                ...
                                <c:if test="${currentPage != i}">
                                    <li class="page-item"><a class="page-link" href="/search-product?name=${key}&currentPage=${i}">${i}</a></li>
                                </c:if>
                            </c:forEach>
                            <c:if test="${currentPage != totalPage}">
                                <li class="page-item">
                                    <a class="page-link" href="/search-product?name=${key}&currentPage=${currentPage+1}" aria-label="Next">
