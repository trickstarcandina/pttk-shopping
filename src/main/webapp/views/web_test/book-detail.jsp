                            ...
                            <form action="/addToCart" method="post">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 mb-6">
                                        <img src="${itemBook.imageUrl}" width="300", height="300px">
                                    ...
                                    <div class="col-lg-6 col-md-6 mb-6">
                                        ...
                                        <h5 class="ml-2" style="color: #d0011b">${itemBook.price} đ</h5>
                                        ...
                                        <br>
                                        <p class="mt-2">Tác giả: ${itemBook.book.author.name}</p>
                                        <p class="mt-2">NXB: ${itemBook.book.publisher.name}</p>
                                        <p class="mt-2">${itemBook.book.description}</p>
                                    </div>
                                </div>
                            </form>
                        </div>
