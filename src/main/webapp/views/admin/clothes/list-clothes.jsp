...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <form action="<c:url value='/admin-delete-clothes'/>" id="formSubmit" method="post">
                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info"
                                               ...
                                               title='Thêm sản phẩm' href='<c:url value="/admin-clothes?type=edit"/>'>
                                                <span>
                                ...
                                <div class="col-xs-12">
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                            <c:forEach var="item" items="${itemClothesList}">
                                                <tr>
                                                    ...
                                                    <td>${item.price}</td>
                                                    <td>
                                                        <c:url var="editURL" value="/admin-clothes">
