...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        <form action="<c:url value='/admin-delete-electronic'/>" id="formSubmit" method="post">
                                    ...
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info"
                                               ...
                                               title='Thêm sản phẩm' href='<c:url value="/admin-electronic?type=edit"/>'>
                                                <span>
