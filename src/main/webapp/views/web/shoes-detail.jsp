					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="${itemShoes.imageUrl}" alt="" />
								<h3>ZOOM</h3>
							</div>
						</div>
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								<h2>${itemShoes.shoes.name}</h2>
								<span>
								...
								<c:if test="${not empty itemShoesForMan}">
									<p><b>Brand:</b> ${itemShoes.shoes.brand}</p>
									<p><b>Origin:</b> ${itemShoes.shoes.origin}</p>
									<p><b>Color:</b> ${itemShoes.shoes.color}</p>
									<p><b>Size:</b> ${itemShoesForMan.size}</p>
									<p><b>Description:</b> ${itemShoes.shoes.description}</p>
									<a href=""><img src="<<c:url value='../../template/images/product-details/share.png'/>" class="share img-responsive"  alt="" /></a>
								</c:if>
								<c:if test="${not empty itemShoesForWomen}">
									<p><b>Brand:</b> ${itemShoes.shoes.brand}</p>
									<p><b>Origin:</b> ${itemShoes.shoes.origin}</p>
									<p><b>Color:</b> ${itemShoes.shoes.color}</p>
									<p><b>Size:</b> ${itemShoesForWomen.size}</p>
									<p><b>SoleHeight:</b> ${itemShoesForWomen.soleHeight}</p>
									<p><b>Description:</b> ${itemShoes.shoes.description}</p>
									<a href=""><img src="<<c:url value='../../template/images/product-details/share.png'/>" class="share img-responsive"  alt="" /></a>
								</c:if>
